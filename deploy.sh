...
echo ""
echo -e "${CYAN}=========================================${NC}"
echo -e "${GREEN}       SHELL DEPLOYER BY CALVIN${NC}"
echo -e "${CYAN}=========================================${NC}"
echo ""
  ...
  "inbounds": [
...

    {
      ...
      "settings": {
        "clients": [
          {
            "id": "d3f1a2b4-7e5c-4f8b-9c1d-2a3b4e5f6a7b",
...
echo "d3f1a2b4-7e5c-4f8b-9c1d-2a3b4e5f6a7b"
echo ""
